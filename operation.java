...
public class operation {
    ...
    public operation(Set<NBook> notebooks) {
        operation.scanner = new Scanner(System.in);
        this.notebooks = notebooks;
    }

    public operation(Set<NBook> notebooks, List<Criterion> criterionList) {
        operation.scanner = new Scanner(System.in);
        this.notebooks = notebooks;
    ...
    public Map<String, String> descriptionsProperties(){
        ...
        map.put("amountRAM", "Объём оперативной памяти");
    ...
    public String getOperations(){
        ...
        String text = "Приветствуем Вас на сайте интернет-магазина: ТЕХНИКА + \n" +
                "Каталог : Ноутбуки \n" +
                "Выберите операцию: \n " +
                "1. Добавить критерий; \n " +
                "2. Вывести список; \n " +
